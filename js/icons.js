// Lucide icons (https://lucide.dev), inline. Uniform 24x24 viewBox, 2px stroke,
// round caps/joins — rendered via icon(name) so the UI never mixes icon styles.
...
const PATHS = {
  ...
  'folder-input': '<path d="M2 9V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-1"/><path d="M2 13h9"/><path d="m8 16 3-3-3-3"/>',
